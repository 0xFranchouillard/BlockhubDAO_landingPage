                  ...
                  <Grid container justifyContent="center" >
                     <Grid item xs={11} sm={10} md={8} >
                        ...
                        <div className='colapse-bg' >
                           ...
                           }} className='colapsebtn' color="secondary" fullWidth >What is BlockHub DAO?   {open.colapse1 ? <ExpandLess /> : <ExpandMore />}</Button>
                        ...
                        <Box my={2} >
                           ...
                           <div className='colapse-bg' >
                              ...
                              }} className='colapsebtn' color="secondary" fullWidth >How does Blockhub DAO operate ? {open.colapse2 ? <ExpandLess /> : <ExpandMore />}</Button>
                        ...
                        <Box my={2} >
                           ...
                           <div className='colapse-bg' >
                              ...
                              }} className='colapsebtn' color="secondary" fullWidth >What kind of projects are you interested in ? {open.colapse2 ? <ExpandLess /> : <ExpandMore />}</Button>
                        ...
                        <Box my={2} >
                           ...
                           <div className='colapse-bg' >
                              ...
                              }} className='colapsebtn' color="secondary" fullWidth >How to Join the Elite? {open.colapse2 ? <ExpandLess /> : <ExpandMore />}</Button>
