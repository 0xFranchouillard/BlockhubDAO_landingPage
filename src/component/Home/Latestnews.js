                              ...
                              <Box my={5} >
                                    <Grid container spacing={4} justifyContent="center" >
                                          ...
                                          <Grid item xs={12} sm={8} md={6} lg={4} >
                                                ...
                                                <div className='port-card-2' >
                                                      <Box component="img" src="/images/Convergence-new.svg" width="100%" className='shutter-img' />
                                                      <div className='shtrpadign' >
                                                            <Typography variant="h4" gutterBottom className='Asset-text'  >
                                          ...
                                          <Grid item xs={12} sm={8} md={6} lg={4} >
                                                ...
                                                <div className='port-card-2' >
                                                      ...
                                                      <div className='shtrpadign' >
                                                            ...
                                                            <Typography variant="h4" gutterBottom className='Apparently-text'  >
                                                                  2022 was a big year for crypto but three major implosions in the industry (Terra-Luna, 3AC and FTX) lead to a bearish market. Even if liquidity issues and insolvencies will likely continue to be discovered in both CeFi and Defi services,
                                                            </Typography>
                                                            <Typography variant="h4" gutterBottom className='March-text'  >
                                                                  March 10th, 2023
                                                            </Typography>
